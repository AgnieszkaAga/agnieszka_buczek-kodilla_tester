...
public class ApplicationTest {
    ...
    public GenericContainer webServer =
            new GenericContainer(
                    new ImageFromDockerfile()
                            .withFileFromClasspath("/tmp/bcard.html", "bcard.html")
                            .withDockerfileFromBuilder(builder ->
                                    builder
                                            .from("httpd:2.4")
                                            .copy("/tmp/bcard.html", "/usr/local/apache2/htdocs")
                                            .build()))
                    .withNetwork(network)
                    .withNetworkAliases("new-server")
                    .withExposedPorts(80);
    ...
    public void customImageTest() throws InterruptedException, IOException {
        ...
        driver.get("http://new-server/bcard.html");
        ...
        assertEquals("Agnieszka Buczek", name);
    }
}
