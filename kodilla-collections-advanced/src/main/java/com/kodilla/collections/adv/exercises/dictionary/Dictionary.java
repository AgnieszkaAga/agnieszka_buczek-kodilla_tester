...
public class Dictionary {
    ...
    public List<EnglishWord> findEnglishWords(String polishWorld, PartOfSpeech partOfSpeech) {
        List<EnglishWord> result = new ArrayList<>();
        for (EnglishWord englishWord : dictionary.getOrDefault(polishWorld,Collections.emptyList()))
        {
